            ...
            <div className="p-5">
                ...
                <div className="mt-5 grid grid-cols-[1fr_auto] items-end gap-4">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="rounded-full bg-accent-bg px-4 py-2 text-sm font-medium text-primary-text ring-1 ring-border transition hover:bg-[color-mix(in srgb, var(--color-accent-bg) 120%, transparent)] active:bg-accent-bg disabled:opacity-50 disabled:cursor-not-allowed"
                        type="button"
                    >
